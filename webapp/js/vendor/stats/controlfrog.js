...
$(document).ready(function(){
	...
	// Step opacity of funnel bars
	$('.cf-scaled-funnel').each(function(){
		var noOfSteps = $('li', $(this)).length;
		var increment = 0.5/noOfSteps;
		var prevOp = 0.6;
		
		for(i=0; i<noOfSteps; i++){
			thisOp = prevOp+(i*increment);
			$('li', $(this)).eq(i).css('opacity', thisOp);
		}
	});	
	
	// Step opacity of 
	$('.cf-scaled-metric').each(function(){
		var noOfSteps = $('li', $(this)).length;
		var increment = 0.5/noOfSteps;
		var prevOp = 0.6;
		...
		for(i=0; i<noOfSteps; i++){
			thisOp = prevOp+(i*increment);
			$('.metric', $(this)).eq(i).css('opacity', thisOp);
		}
...
$(document).ready(function(){
	...
	$('#cf-gauge-1').each(function(){
		...
		updateOpts = {'minVal':'0','maxVal':'886','newVal':'689'};
